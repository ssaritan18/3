export default {
  expo: {
    ...
    extra: {
      ...
      ENABLE_ADMOB: process.env.EXPO_PUBLIC_ENABLE_ADMOB === 'true' || true,
      ENABLE_ANIMATIONS: process.env.EXPO_PUBLIC_ENABLE_ANIMATIONS === 'true' || true,
      ENABLE_REANIMATED: process.env.EXPO_PUBLIC_ENABLE_REANIMATED === 'true' || true,
      eas: {
